        ...
        <div class="NewUpdate">
            ...
            <div class="item-container">
                    <div class="item">
                            ...
                            @endif
                        <form action="{{url('eatdrinkupdate/add/{id}')}}" method="POST" enctype="multipart/form-data">
                            <!--id -->
                            ...
                            <!--/shop_name -->
                            <div class="shopupdateeatdrinkcategory">
                                <div class="form-group mt-2">
                            ...
                            <!--Saveボタン/Backボタン -->
                            <div class="shopupdateeatdrink">
                                <button type="submit">保存</button>
                                <a class="btn btn-link pull-right" href="{{ url('furnituregoods/')}}">戻る</a>
                            </div>
                           <!--Saveボタン/Backボタン -->
