            ...
            <div class="NewUpdate">
                ...
                <div class="item-container">
                    <div class="item">
                        ...
                        @endif
                        <form action="{{url('fashionableupdate/add/{id}')}}" method="POST" enctype="multipart/form-data">
                            <!--id -->
                            ...
                            <!--/shop_name -->
                            <div class="shopupdatefashionablecategory">
                                <div class="form-group mt-2">
                            ...
                            <!--Saveボタン/Backボタン -->
                            <div class="shopupdatefashionable">
                                <button type="submit">保存</button>
                                <a class="btn btn-link pull-right" href="{{ url('fashionables/')}}">戻る</a>
                            </div>
                            <!--Saveボタン/Backボタン -->
