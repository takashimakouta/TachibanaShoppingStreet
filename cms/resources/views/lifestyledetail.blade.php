        ...
        <div class="NewRegister">
            ...
            <div class="item">
                ...
                <div class="shopdetail">
                    <div class="shopdetaillifestyle">
                        <button type="submit" >暮らし</button>
                    </div>
                    
                    <div class="shopdetaillifestyleshopexplain">
                        <div class="form-group mt-2">
                            {{$shopliststock->shop_explain}}
                        </div>
                    </div>
                    <div class="shopdetaillifestylecategory">
                        <div class="form-group mt-2">
            ...
            @csrf
                ...
                <p></p>
                <div align="center" class= "shopdetaillifestyleback">
