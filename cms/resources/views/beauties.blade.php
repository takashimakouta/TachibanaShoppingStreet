...
　　        </nav>
    ...
    <main>
        ...
        <div class="shoplistwhole">
            ...
            @auth
                <div class="ml-auto"> 
                     <form action="{{ url('beautiesCreate/') }}" method="GET"> 
            ...
            <div class="item-container">
                    @foreach($shopliststocks as $shopliststock)
                        <a href="{{ url('beautydetail/' .$shopliststock->id) }}" class="beautyitem text-decoration-none" >
                                <div><img src="{{ asset('storage/images/'.$shopliststock->shop_img)}}" alt=""></div>
                                <p></p>
                                <p class="beautycategory">{{$shopliststock->shop_category}}</p>
                                <p class="shop_name">{{$shopliststock->shop_name}}</p>  
                                <p class="shop_summary">{{$shopliststock->shop_explain}}</p>
                                <div class="shop_revise_beauty">
                                    <form action="{{ url('beautyupdate/' .$shopliststock->id) }}" method="GET">
                                    @csrf
                                        <p><button type="submit" class="btn btn-primary">更新</button></p>
                                    </form> 
                                    <form action="{{ url('beautydelete/' . $shopliststock->id) }}" method="POST"
