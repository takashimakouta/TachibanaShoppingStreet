        ...
        <h1><a href="/" target="_self">TACHIBANA SHOPS STREET</a>
            ...
            <nav>
                 <ul style="list-style: none;">
                    ...
                    　<a href="{{ url('medicals/')}}" method="GET">
                    　<p>STORE<br>
                    店舗一覧</p>
                    　</a>
                    </li>
            ...
            <div class="NewUpdate">
                ...
                <div class="item-container">
                    <div class="item">
                        ...
                        @endif
                        <form action="{{url('medicalupdate/add/{id}')}}" method="POST" enctype="multipart/form-data">
                            <!--id -->
                            ...
                            <!--/shop_name -->
                            <div class="shopupdatemedicalcategory">
                                <div class="form-group mt-2">
                            ...
                            <!--Saveボタン/Backボタン -->
                            <div class="shopupdatemedical">
                                <button type="submit">保存</button>
                                <a class="btn btn-link pull-right" href="{{ url('medicals/')}}">戻る</a>
                            </div>
                           <!--Saveボタン/Backボタン -->
