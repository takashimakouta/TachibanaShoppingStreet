        ...
        <div class="shoplistwhole">
                    ...
                    <thead>
                        ...
                        <th class="beauty">
                            <form action="{{ url('beauties/') }}" method="GET"> 
                                <button type="submit" class="btn btn-primary">美容・理容・エステ</button>
                            </form>
                        </th>
            ...
            <div class="item-container">
                    @foreach($shopliststocks as $shopliststock)
                        <a href="{{ url('eatdrink/' .$shopliststock->id) }}" class="eatdrinkitem text-decoration-none" >
                                <div><img src="{{ asset('storage/images/'.$shopliststock->shop_img)}}" alt=""></div>
                                <p></p>
                                <p class="eatdrinkcategory">{{$shopliststock->shop_category}}</p>
                                <p class="shop_name">{{$shopliststock->shop_name}}</p>  
                                <p class="shop_summary">{{$shopliststock->shop_explain}}</p>
                                <div class="shop_revise_eatdrink">
                                    <form action="{{ url('eatdrinkupdate/' .$shopliststock->id) }}" method="GET">
                                    @csrf
                                        <p><button type="submit" class=shopdetailupdate>更新</button></p>
                                    </form> 
