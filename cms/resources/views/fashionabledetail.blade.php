        ...
        <div class="NewRegister">
            ...
            <div class="item">
                ...
                <div class="shopdetail">
                    <div class="shopdetailfashionable">
                        <button type="submit" >おしゃれ</button>
                    </div>
                    <div class="shopdetailfashionableshopexplain">
                        <div class="form-group mt-2">
                            {{$shopliststock->shop_explain}}
                        </div>
                    </div>
                    <div class="shopdetailfashionablecategory">
                        <div class="form-group mt-2">
            ...
            @csrf
                ...
                <p></p>
                <div align="center" class= "shopdetailfashionableback">
