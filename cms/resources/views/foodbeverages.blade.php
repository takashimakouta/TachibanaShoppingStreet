...
　　        </nav>
    ...
    <main>
        ...
        <div class="shoplistwhole">
            ...
            @auth
                <div class="ml-auto"> 
                     <form action="{{ url('foodbeveragesCreate/') }}" method="GET"> 
            ...
            <div class="item-container">
                    @foreach($shopliststocks as $shopliststock)
                            <a href="{{ url('foodbeveragesdetail/' .$shopliststock->id) }}" class="foodbeverageitem text-decoration-none" >
                                <div><img class="foodbeverageimg" src="{{ asset('storage/images/'.$shopliststock->shop_img)}}" alt=""></div>
                                <p></p>
                                <p class="foodbeveragecategory">{{$shopliststock->shop_category}}</p>
                                <p class="shop_name">{{$shopliststock->shop_name}}</p>  
                                <p class="shop_summary">{{$shopliststock->shop_explain}}</p>
                                <div class="shop_revise_foodbeverage">
                                    <form action="{{ url('foodbeverageupdate/' .$shopliststock->id) }}" method="GET">
                                    @csrf
