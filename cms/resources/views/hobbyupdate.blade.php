          ...
          <h1>店舗更新ページ</h1>
            <div class="item-container">
                <div class="item">
                    ...
                    @endif
                    <form action="{{url('hobbyupdate/add/{id}')}}" method="POST" enctype="multipart/form-data">
                        <!--id -->
                        ...
                        <!--id -->
                             ...
                             <!--/shop_name -->
                            <div class="shopupdatehobbycategory">
                                <div class="form-group mt-2">
                            ...
                            <!--Saveボタン/Backボタン -->
                            <div class="shopupdatehobby">
                                <button type="submit">保存</button>
                                <a class="btn btn-link pull-right" href="{{ url('hobbys/')}}">戻る</a>
                            </div>
                           <!--Saveボタン/Backボタン -->
                ...
                <div class="iphoneitem">
                    ...
                    <form action="{{url('hobbyupdate/add/{id}')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <!--id -->
                            ...
                            <div class="shopupdatehobbycategory">
                                <div class="form-group mt-2">
                                    <label for="shop_category">分類</label>
                                    <input type="text" name="shop_category"  class="form-control" value="">
                                </div>
                            </div>
                            <!--/shop_category -->
