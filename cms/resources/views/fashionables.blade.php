...
　　        </nav>
    ...
    <main>
        ...
        <div class="shoplistwhole">
            ...
            @auth
                <div class="ml-auto"> 
                     <form action="{{ url('fashionablesCreate/') }}" method="GET"> 
            ...
            <div class="item-container">
                    @foreach($shopliststocks as $shopliststock)
                        <a href="{{ url('fashionabledetail/' .$shopliststock->id) }}" class="fashionableitem text-decoration-none" >
                                <div><img src="{{ asset('storage/images/'.$shopliststock->shop_img)}}" alt=""></div>
                                <p></p>
                                <p class="fashionablecategory">{{$shopliststock->shop_category}}</p>
                                <p class="shop_name">{{$shopliststock->shop_name}}</p>  
                                <p class="shop_summary">{{$shopliststock->shop_explain}}</p>
                                <div class="shop_revise_fashionable">
                                    <form action="{{ url('fashionableupdate/' .$shopliststock->id) }}" method="GET">
                                    @csrf
