            ...
            <div class="NewUpdate">
                ...
                <div class="item-container">
                        <div class="item">
                                ...
                                @endif
                                <form action="{{url('foodbeverageupdate/add/{id}')}}" method="POST" enctype="multipart/form-data">
                                <!--id -->
                                ...
                                <!--/shop_name -->
                                <div class="shopupdatefoodbeveragecategory">
                                    <div class="form-group mt-2">
                                ...
                                <!--Saveボタン/Backボタン -->
                                <div class="shopupdatefoodbeverage">
