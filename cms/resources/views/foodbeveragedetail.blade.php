        ...
        <div class="NewRegister">
            ...
            <div class="item">
                ...
                <div class="shopdetail">
                    <div class="shopdetailfoodbeverage">
                        <button type="submit" >食料品・飲料</button>
                    </div>
                    <div class="shopdetailfoodbeverageshopexplain">
                        <div class="form-group mt-2">
                            {{$shopliststock->shop_explain}}
                        </div>
                    </div>
                    <div class="shopdetailfoodbeveragecategory">
                        <div class="form-group mt-2">
            ...
            @csrf
                ...
                <p></p>
                <div align="center" class= "shopdetailfoodbeverageback">
