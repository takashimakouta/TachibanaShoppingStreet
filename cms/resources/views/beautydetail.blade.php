        ...
        <div class="NewRegister">
            ...
            <div class="item">
                ...
                <div class="shopdetail">
                    <div class="shopdetailbeauty">
                        <button type="submit" >美容・利用・エステ</button>
                    </div>
                    <div class="shopdetailbeautyshopexplain">
                        <div class="form-group mt-2">
                            {{$shopliststock->shop_explain}}
                        </div>
                    </div>
                    <div class="shopdetailbeautycategory">
                        <div class="form-group mt-2">
            ...
            @csrf
                ...
                <p></p>
                <div align="center" class= "shopdetailbeautyback">
