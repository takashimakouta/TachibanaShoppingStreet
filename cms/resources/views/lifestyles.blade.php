...
　　        </nav>
    ...
    <main>
        ...
        <div class="shoplistwhole">
            ...
            @auth
                <div class="ml-auto"> 
                     <form action="{{ url('lifestylesCreate/') }}" method="GET"> 
            ...
            <div class="item-container">
                    @foreach($shopliststocks as $shopliststock)
                        <a href="{{ url('lifestyledetail/' .$shopliststock->id) }}" class="lifestyleitem text-decoration-none" >
                                <div><img src="{{ asset('storage/images/'.$shopliststock->shop_img)}}" alt=""></div>
                                <p></p>
                                <p class="lifestylecategory">{{$shopliststock->shop_category}}</p>
                                <p class="shop_name">{{$shopliststock->shop_name}}</p>  
                                <p class="shop_summary">{{$shopliststock->shop_explain}}</p>
                                <div class="shop_revise_lifestyle">
                                    <form action="{{ url('lifestyleupdate/' .$shopliststock->id) }}" method="GET">
                                    @csrf
                                        <p><button type="submit" class="btn btn-primary">更新</button></p>
                                    </form> 
                                    <form action="{{ url('lifestyledelete/' . $shopliststock->id) }}" method="POST"
